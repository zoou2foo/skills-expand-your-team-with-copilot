document.addEventListener("DOMContentLoaded", () => {
  ...
  function displayFilteredActivities() {
    ...
    Object.entries(allActivities).forEach(([name, details]) => {
      ...
      } else if (currentDifficulty && details.difficulty && details.difficulty !== currentDifficulty) {
        // Specific level selected: show activities with that level or with no difficulty (for all levels)
        return;
      }
